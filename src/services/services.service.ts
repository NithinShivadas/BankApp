...
export class ServicesService {
  ...
  RegisterAccount(fName:any,LName:any,Accno:any,Address:any,Aadhar:any,mobile:any,eMail:any,password:any,cnfrmPassword:any,balance:any)
  {
    const regData={
          fName,
          LName,
  ...
  withdraw(Accno:any,password:any,amount:any){
    // console.log("Workingggg...!!!!!!")
     ...
     return this.http.post('http://localhost:3001/withdraw',depositeData,this.getOptions())
   }
}
